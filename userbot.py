...
async def on_join(client, message):
    if message.from_user and message.from_user.is_self:
        try:
            # Send a minimal message and delete it immediately
